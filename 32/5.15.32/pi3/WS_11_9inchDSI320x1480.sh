...
#Move driver file
sudo cp WS_11_9inchDSI320x1480_Touch.ko /lib/modules/$(uname -r)
sudo cp WS_11_9inchDSI320x1480_Screen.ko /lib/modules/$(uname -r)
sudo cp WS_11_9inchDSI320x1480_Touch.dtbo /boot/overlays
sudo cp WS_11_9inchDSI320x1480_Screen.dtbo /boot/overlays
...
#Install driver
sudo depmod
sudo modprobe WS_11_9inchDSI320x1480_Touch
sudo modprobe WS_11_9inchDSI320x1480_Screen
...
Data_Insertion config.txt  "dtoverlay=WS_11_9inchDSI320x1480_Screen"
#Data_Insertion config.txt  "# -------------touch---------------"
Data_Insertion config.txt  "dtparam=i2c_vc=on"
Data_Insertion config.txt  "dtoverlay=WS_11_9inchDSI320x1480_Touch,invertedx,invertedy"
